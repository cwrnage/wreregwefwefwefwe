...
do
	function Library:NewPicker(name, default, parent, count, flag, callback)
		...
		HueBar.Size = UDim2.new(0, 160, 0, 8)
		...
		HueSlider.Size = UDim2.new(0, 12, 0, 12)
...
function Pages:Section(Properties)
	...
	local Properties = Properties or {}
	local TextboxName = Properties.Name or Properties.name or nil  -- NEW: Optional label/title
	...
	-- Input Frame (shifted down if label)
	local ToggleFrame = Instance.new("Frame")
	ToggleFrame.Name = "ToggleFrame"
	ToggleFrame.BackgroundColor3 = Color3.fromRGB(13, 13, 13)
	ToggleFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
	ToggleFrame.BorderSizePixel = 0
	ToggleFrame.Position = UDim2.new(0, 0, 0, extraHeight)  -- Shift down for label
	ToggleFrame.Size = UDim2.new(1, 0, 0, 24)
